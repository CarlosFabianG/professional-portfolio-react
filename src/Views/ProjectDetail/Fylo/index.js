...
import hero from './image-fylo-hero.jpg'
    ...
    return(
        ...
        <StyledMain>
            <article>
                ...
                <span>HTML / SCSS</span>
                <a href="https://manage-landingpage-cf.netlify.app" target="_blank" rel="noopener noreferrer"><button>Visitar Website</button></a>
            </article>
        ...
        < PreviousNext next="Geek Blog" 
                       nextProject="/projects/sm-dashboard" 
                       previous="Manage"
                       previousProject="/projects/manage"/>
        <ContactMe />
        </>
    )
}
